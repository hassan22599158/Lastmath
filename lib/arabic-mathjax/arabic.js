 ...
 * The MIT License
 *
 * Modified to fix Arabic Text mirroring inside \alwaysar
 */
  ...
  MathJax.Hub.Config({
    'HTML-CSS': {
      styles: {
        ...
        /* --- التعديل 1: إضافة قاعدة CSS للنصوص --- */
        /* القاعدة دي بتقول: لو لقيت نص (ar-text) جوه حاجة مقلوبة (mfliph) */
        /* اقلبه تاني (-1) عشان يظهر معدول للقارئ */
...
MathJax.Extension.Arabic = {
  ...
  /* --- التعديل 2: تمييز النصوص بكلاس خاص --- */
  Text: function (english, arabicText) {
    // بنضيف كلاس "ar-text" حوالين النص عشان الـ CSS يتعرف عليه ويعكسه
