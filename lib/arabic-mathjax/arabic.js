 ...
 * The MIT License
 *
 * Modified to fix Arabic Text readability without breaking the library logic.
 */
  ...
  MathJax.Hub.Config({
    'HTML-CSS': {
      styles: {
        ...
        /* --- الإضافة الوحيدة هنا --- */
        /* هذا الكلاس يقوم بعكس النص مرة أخرى ليعادل عكس المكتبة */
        '.MathJax .ar-text': {
          'display': 'inline-block !important',
...
MathJax.Extension.Arabic = {
  ...
  Text: function (english, arabicText) {
    // 1. حافظنا على \fliph عشان مكان النص يروح يمين (زي المكتبة الأصلية بالظبط)
    // 2. ضفنا class="ar-text" اللي بيعمل scaleX(-1)
    // النتيجة: النص بيتعكس جوه الصندوق المعكوس = بيظهر معدول
