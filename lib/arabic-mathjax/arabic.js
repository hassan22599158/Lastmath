 ...
 * The MIT License
 *
 * Modified to fix Arabic Text direction inside \alwaysar using standard \text command
 */
  ...
  MathJax.Hub.Config({
    'HTML-CSS': {
      styles: {
        ...
        /* ده بيضمن إن الكلمات جوه \text تظهر معدولة سواء كانت جوه alwaysar أو لأ */
...
MathJax.Extension.Arabic = {
  ...
  Text: function (english, arabicText) {
    // استخدمنا \fliph عشان المحاذاة، و \class{munflip} عشان تعديل النص
    return MathJax.Extension.Arabic.TeX(english, '\\fliph{\\class{munflip}{\\text{' + arabicText + '}}}');
  },
  /* -------------------------- */
...
MathJax.Hub.Register.StartupHook('TeX Jax Ready', function () {
  ...
  TEX.Definitions.Add({
    macros: {
      ...
      // شلنا الأمر txt عشان نعتمد على الأساسي
    }
  });
